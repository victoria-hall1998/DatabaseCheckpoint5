...
public class CSE3241app {
     ...
     */
    private static String DATABASE = "database_binary.db";//C:\\Users\\Dell\\git\\DatabaseCheckpoint5\\Checkpoint5\\database_binary";
    ...
    public static void orderItemsOption(Scanner input) {
        ...
        switch (option) {
            ...
            case 'b':
                ...
                while (!CSE3241IOUtil.checkWorkID(workID)) {
                ...
                case "album":
                	...
                	try {
						if(value.length()==0){
							System.out.println("Enter a title for the album: ");
							String title = input.nextLine();
							System.out.println("How many songs are on the album? ");
							String songCount = input.nextLine();
							System.out.println("Enter a genre for the album: ");
							String genre = input.nextLine();
							System.out.println("Enter a duration in HH:MM:SS: ");
							String time = input.nextLine();
                ...
                case "audiobook":
                	...
                	try {
						if(value3.length()==0){
							System.out.println("Enter a title for the audiobook: ");
							String title = input.nextLine();
							System.out.println("How many chapters are in the audiobook? ");
							String chapters = input.nextLine();
							System.out.println("How many pages are in the audiobook? ");
							String pages = input.nextLine();
							System.out.println("Enter a genre for the audiobook: ");
							String genre = input.nextLine();
							System.out.println("Enter a rating for the audiobook: ");
							String rating = input.nextLine();
							 while (!CSE3241IOUtil.checkDoubleFormatting(rating)
				                        && !rating.isBlank()) {
				                    System.out.println("You entered an invalid rating.");
                	...
                	break;
                default:
                	System.out.println("Invalid data type, trying to search for " + type);
                }
